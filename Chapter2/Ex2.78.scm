...
;;; primitives of the language directly because our type-tag system requires
...
;;; from section 2.4.2 so that our generic system takes advantage of Scheme
;;; 's internal type system. That is to say, the syste, should work as before except
